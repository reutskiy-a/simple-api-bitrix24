...
class OperationTimeLimitServiceTest extends TestCase
{
    ...
    public function testQueryLimitExceededThrowsExceptionOnWebhookSingleRequest(): void
    {
        ...
        $guzzleClient = $this->getGuzzleHttpClientMock(self::ERROR_OPERATION_TIME_LIMIT, 429);
        ...
        $reflectionOperationTimeLimitService = new ReflectionClass($apiSettings->getOperationTimeLimitService());
        $contValue = $reflectionOperationTimeLimitService->getConstant('ERROR_RESPONSE');
    ...
    public function testQueryLimitHandledSuccessfullyOnWebhookSingleRequest(): void
    {
        ...
        $reflectionService = new ReflectionClass($apiSettings->getOperationTimeLimitService());
        $propertyService = $reflectionService->getProperty('usleep');
        $propertyService->setValue($apiSettings->getOperationTimeLimitService(), 0);
        ...
        $guzzleClient = $this->getGuzzleHttpClientMockQueue([
            new Response(429, [], json_encode(self::ERROR_OPERATION_TIME_LIMIT)),
            new Response(429, [], json_encode(self::ERROR_OPERATION_TIME_LIMIT)),
            new Response(429, [], json_encode(self::ERROR_OPERATION_TIME_LIMIT)),
            new Response(429, [], json_encode(self::ERROR_OPERATION_TIME_LIMIT)),
            new Response(429, [], json_encode(self::ERROR_OPERATION_TIME_LIMIT)),
